...
public:
	...
	void query_knn(weighted_aab *box, float *transform, vector<pair<int, range>> &results, float &max_maxdist, const int k=1);
	void query_knn_fast(weighted_aab *box, float *transform, vector<pair<int, range>> &results, float &max_maxdist, const int k=1);
	void query_within(weighted_aab *box, float *transform, vector<pair<int, range>> &results, const float min_farthest);
