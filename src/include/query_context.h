...
public:
	...
	result_container *results_s[2] = {NULL,NULL};

	// float *results_s[2] = {NULL,NULL};

	float *data[2] = {NULL, NULL};
	float *hausdorff[2] = {NULL, NULL};
	size_t *offset_size[2] = {NULL, NULL};
	int *location[2] = {NULL, NULL};
